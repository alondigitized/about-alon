...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "hero.kicker": "匠 心 营 造",
      "hero.title": "朱师傅",
      "hero.sub": "让每一个空间，透得进光，也藏得住故事。",
      "hero.tagline": "匠心四十载，从南加州每一个家开始",
      "hero.cta": "看看他的作品 ↓",
      "about.label": "关于朱师傅",
    ...
    en: {
      ...
      "hero.sub": "Every space lets the light in — and holds a story close.",
      "hero.tagline": "Forty years of craft, beginning with every home in Southern California.",
