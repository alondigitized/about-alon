...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "about.body1": "朱师傅做装修二十多年。墙要平到能当镜子照，砖缝要齐到处女座看了都安心，水电藏得干干净净——别人嘴里那句“差不多就行了”，到他这儿一律不存在，只有“正正好”。",
      "about.body2": "下面这两套民宿，从砸墙到收尾，每道工序他都亲自盯着。朱师傅不爱说漂亮话——毕竟活儿好不好，房子自己会开口。",
    ...
    en: {
      ...
      "about.body1": "Master Zhu has spent more than twenty years renovating homes. Walls flat enough to use as a mirror, grout lines straight enough to soothe even the fussiest eye, plumbing and wiring tucked clean away. The phrase 'eh, close enough' simply doesn't exist in his vocabulary — only 'exactly right.'",
      "about.body2": "The two rentals below were overseen by his own hands, from the first wall down to the final seam. Master Zhu isn't one for sweet talk — then again, good work speaks for itself.",
